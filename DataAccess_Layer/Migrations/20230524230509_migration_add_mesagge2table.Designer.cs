...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20230524230509_migration_add_mesagge2table")]
    partial class migration_add_mesagge2table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity_Layer.Concrete.BlogRayting", b =>
                {
            ...
            modelBuilder.Entity("Entity_Layer.Concrete.Message2", b =>
                {
                    b.Property<int>("MessageID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity_Layer.Concrete.NewsLetter", b =>
                {
            ...
            modelBuilder.Entity("Entity_Layer.Concrete.Notification", b =>
                {
                    ...
                    b.Property<string>("NotificatinColor")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Entity_Layer.Concrete.Blog", b =>
                {
                    ...
                    b.HasOne("Entity_Layer.Concrete.Writer", "Writer")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("Entity_Layer.Concrete.Message2", b =>
                {
                    b.HasOne("Entity_Layer.Concrete.Writer", "ReceiverUser")
                        .WithMany("WriterReceiver")
                        .HasForeignKey("ReceiverID");

                    b.HasOne("Entity_Layer.Concrete.Writer", "SenderUser")
